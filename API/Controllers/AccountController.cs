...
namespace API.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public AccountController(UserManager<AppUser> userManager,
            ...
            SignInManager<AppUser> signInManager, EmailSender emailSender)
        {
        ...
        public async Task<ActionResult<UserDto>> Register(RegisterDto registerDto)
        {
            if (await _userManager.Users.AnyAsync(x => x.Email == registerDto.Email))
            {
                ...
                return ValidationProblem("Email is already taken");
            }
            ...
            await _emailSender.SenderEmailAsync(user.Email, "Please verify email", message);
        ...
        public async Task<ActionResult<UserDto>> FacebookLogin(string accessToken)
        {
            ...
            if (!results.Succeeded) return BadRequest("Problem creating user account");
            await SetRefreshToken(user);
            return CreateUserObject(user);
        }
